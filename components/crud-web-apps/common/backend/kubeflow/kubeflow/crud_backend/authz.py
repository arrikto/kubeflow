...
def generate_unauthorized_message(verb, group, version, resource,
...
def ensure_authorized(verb, group, version, resource, namespace=None,
    ...
    if not is_authorized(user, verb, group, version, resource,
        ...
        msg = generate_unauthorized_message(verb, group, version, resource,
                                            subresource=subresource,
                                            namespace=namespace)
